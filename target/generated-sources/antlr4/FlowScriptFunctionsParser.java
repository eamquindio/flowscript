...
public class FlowScriptFunctionsParser extends Parser {
	...
	public static final int
		FUNCTION=1, RETURN=2, IF=3, ELSE_IF=4, ELSE=5, TRY=6, CATCH=7, FINALLY=8, 
		THROW=9, WHILE=10, FOR=11, EACH=12, IN=13, FROM=14, TO=15, STEP=16, BREAK=17, 
		CONTINUE=18, INTEGER_T=19, DECIMAL_T=20, BOOLEAN_T=21, TEXT_T=22, LIST_T=23, 
		OBJECT_T=24, VOID_T=25, NULL=26, TRUE=27, FALSE=28, ARROW=29, ASSIGN=30, 
		DOT=31, COMMA=32, COLON=33, SEMI=34, LPAREN=35, RPAREN=36, LBRACE=37, 
		RBRACE=38, LBRACK=39, RBRACK=40, PLUS=41, MINUS=42, MUL=43, DIV=44, MOD=45, 
		LT=46, GT=47, LE=48, GE=49, EQ=50, NEQ=51, AND=52, OR=53, NOT=54, IDENTIFIER=55, 
		INTEGER_LITERAL=56, DECIMAL_LITERAL=57, STRING_LITERAL=58, LINE_COMMENT=59, 
	...
	public static final int
		...
		RULE_statement = 7, RULE_variableAssignment = 8, RULE_leftHandSide = 9, 
		RULE_memberAccess = 10, RULE_indexAccess = 11, RULE_ifStatement = 12, 
		RULE_elseIfClause = 13, RULE_whileStatement = 14, RULE_forEachStatement = 15, 
		RULE_forRangeStatement = 16, RULE_breakStatement = 17, RULE_continueStatement = 18, 
		RULE_returnStatement = 19, RULE_tryCatchStatement = 20, RULE_catchClause = 21, 
		RULE_throwStatement = 22, RULE_expressionStatement = 23, RULE_expression = 24, 
		RULE_orExpression = 25, RULE_andExpression = 26, RULE_equalityExpression = 27, 
		RULE_relationalExpression = 28, RULE_additiveExpression = 29, RULE_multiplicativeExpression = 30, 
		RULE_unaryExpression = 31, RULE_postfixExpression = 32, RULE_postfixOp = 33, 
		RULE_primaryExpression = 34, RULE_argumentList = 35, RULE_literal = 36, 
		RULE_integerLiteral = 37, RULE_decimalLiteral = 38, RULE_booleanLiteral = 39, 
		RULE_nullLiteral = 40, RULE_stringLiteral = 41, RULE_listLiteral = 42, 
		RULE_objectLiteral = 43, RULE_objectPair = 44;
	private static String[] makeRuleNames() {
		return new String[] {
			"functionProgram", "functionDeclaration", "functionName", "parameterList", 
			"parameter", "type", "block", "statement", "variableAssignment", "leftHandSide", 
			"memberAccess", "indexAccess", "ifStatement", "elseIfClause", "whileStatement", 
			"forEachStatement", "forRangeStatement", "breakStatement", "continueStatement", 
			"returnStatement", "tryCatchStatement", "catchClause", "throwStatement", 
			...
			"argumentList", "literal", "integerLiteral", "decimalLiteral", "booleanLiteral", 
			"nullLiteral", "stringLiteral", "listLiteral", "objectLiteral", "objectPair"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'function'", "'return'", "'if'", "'else_if'", "'else'", "'try'", 
			"'catch'", "'finally'", "'throw'", "'while'", "'for'", "'each'", "'in'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "FUNCTION", "RETURN", "IF", "ELSE_IF", "ELSE", "TRY", "CATCH", 
			"FINALLY", "THROW", "WHILE", "FOR", "EACH", "IN", "FROM", "TO", "STEP", 
			"BREAK", "CONTINUE", "INTEGER_T", "DECIMAL_T", "BOOLEAN_T", "TEXT_T", 
			"LIST_T", "OBJECT_T", "VOID_T", "NULL", "TRUE", "FALSE", "ARROW", "ASSIGN", 
			"DOT", "COMMA", "COLON", "SEMI", "LPAREN", "RPAREN", "LBRACE", "RBRACE", 
			"LBRACK", "RBRACK", "PLUS", "MINUS", "MUL", "DIV", "MOD", "LT", "GT", 
			"LE", "GE", "EQ", "NEQ", "AND", "OR", "NOT", "IDENTIFIER", "INTEGER_LITERAL", 
			"DECIMAL_LITERAL", "STRING_LITERAL", "LINE_COMMENT", "BLOCK_COMMENT", 
			"WS"
		};
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 558451473865117260L) != 0)) {
				{
				{
				setState(128);
				statement();
	...
	public static class VariableAssignmentContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).enterVariableAssignment(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).exitVariableAssignment(this);
		}
	}
	...
	public final LeftHandSideContext leftHandSide() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_leftHandSide);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final IndexAccessContext indexAccess() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_indexAccess);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(182);
	...
	public final ForRangeStatementContext forRangeStatement() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_forRangeStatement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class TryCatchStatementContext extends ParserRuleContext {
		...
		public TerminalNode FINALLY() { return getToken(FlowScriptFunctionsParser.FINALLY, 0); }
	...
	public static class OrExpressionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).enterOrExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).exitOrExpression(this);
		}
	}
	...
	public static class AndExpressionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).enterAndExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).exitAndExpression(this);
		}
	}
	...
	public final PostfixOpContext postfixOp() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_postfixOp);
		int _la;
		try {
			setState(325);
			_errHandler.sync(this);
			...
			case LPAREN:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 558451473864720384L) != 0)) {
					{
					setState(319);
					argumentList();
					}
	...
	public static class BooleanLiteralContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).enterBooleanLiteral(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).exitBooleanLiteral(this);
		}
	}
	...
	public static class StringLiteralContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).enterStringLiteral(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FlowScriptFunctionsListener ) ((FlowScriptFunctionsListener)listener).exitStringLiteral(this);
		}
	}
	...
	public final ListLiteralContext listLiteral() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_listLiteral);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ObjectPairContext objectPair() throws RecognitionException {
		...
		enterRule(_localctx, 88, RULE_objectPair);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(388);
