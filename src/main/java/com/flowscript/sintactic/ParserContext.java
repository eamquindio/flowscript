 ...
 *
 * <p>
 * Mantiene el estado del análisis sintáctico incluyendo la lista de tokens
 * y el índice actual. Provee métodos de utilidad para navegar y consumir
 * tokens.
 * </p>
 */
public class ParserContext {
   ...
   * @return El token en la posición actual + offset, o null si está fuera de
   *         rango
   */
