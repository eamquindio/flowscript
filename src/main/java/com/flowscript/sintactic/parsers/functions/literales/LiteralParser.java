...
public class LiteralParser implements IParser<LiteralNode> {
    ...
    public LiteralNode parse(ParserContext context) throws Parser.ParseException {
        ...
        if (current == null) {
            throw new Parser.ParseException("Fin de entrada inesperado mientras se analizaba Literal");
        }
        ...
        switch (type) {
            ...
            default:
                throw new Parser.ParseException(
                    "Token inesperado en Literal: " + current.getValue() +
                    " (" + type + ") en linea " + current.getLine() + ", columna " + current.getColumn()
                );
        }
    }
