...
public class DecimalLiteralParser implements IParser<DecimalLiteralNode> {
    ...
    public DecimalLiteralNode parse(ParserContext context) throws Parser.ParseException {
        ...
        if (current == null) {
            throw new Parser.ParseException("Fin de entrada inesperado mientras se analizaba literal decimal");
        }
        ...
        throw new Parser.ParseException(
            "Se esperaba literal decimal pero se encontro '" + current.getValue() + 
