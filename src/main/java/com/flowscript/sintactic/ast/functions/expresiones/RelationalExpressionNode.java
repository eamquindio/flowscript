...
/**
 * Represents relational expressions: expr < expr, expr > expr, expr <= expr,
 * expr >= expr
 * Grammar: RelationalExpression ::= AdditiveExpression ( ( '<' | '>' | '<=' |
 * '>=' ) AdditiveExpression )*
...
public class RelationalExpressionNode extends ExpressionNode {
  ...
  public RelationalExpressionNode(Token firstToken, ExpressionNode firstOperand) {
    super(firstToken);
